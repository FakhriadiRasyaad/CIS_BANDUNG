...
<div class="container">
    ...
    <div class="main-content">
        ...
        <div id="addacc" class="content" style="display: none;">
            ...
            <form action="co_admin.php" method="POST">
        ...
        <div id="listacc" class="content" style="display: none;">
            ...
            <table border="1">
                ...
                while ($row = mysqli_fetch_assoc($result_users)) {
                    // Memeriksa jika akses_id adalah 'co-admin' atau 'staff' dan login_id bukan 13
                    if ($row['akses_id'] === 'staff' && $row['login_id'] != 13 && 
                        $row['akses_id'] !== 'admin' && 
                        $row['akses_id'] !== 'co-admin' && 
                        $row['akses_id'] !== 'aadmin') {
                        echo "<tr>";
                        ...
                        echo "<div class='delete-button'>
                                <a href='co_admin.php?delete_id=" . $row['login_id'] . "' 
